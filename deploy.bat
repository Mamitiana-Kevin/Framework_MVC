...
set "FRAMEWORK_DIR=D:\ETUDE\S5\Mr_Naina\Framework\GITHUB\Framework_MVC"
set "BUILD_DIR=%FRAMEWORK_DIR%\build"
set "TEST_DIR=C:\Users\Mamitiana\Documents\installation\tomcat-10.1.28-windows-x64\apache-tomcat-10.1.28\webapps\testFramework"
